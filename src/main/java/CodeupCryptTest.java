...
//    to make sure they match with a valid hash.
    ...
    public void testCheckPassword(){
        ...
        assertFalse("check password", CodeupCrypt.checkPassword("moolanding", "m00nl4nd1ng"));
    }

//    The hashing procedure should be pretty simple, just replace the original String's
//    vowels with numbers, these are the rules:
